...
EntryRemote.prototype.SendMessageByUid=function(uid,route,msg,cb)
{
	var sessionService=this.app.sessionService;
	sessionService.sendMessageByUid(uid,{
		route:route,
		msg:msg
	});
...
//  *
//  */
// EntryRemote.prototype.joingamechannel=function(uid,gameid,cb)
// {
// 	var sessionService=this.app.get('sessionService');
// 	var session=sessionService.getByUid(uid)[0];

// 	var isset=session.get('gameid');
...
//  *
//  */
// EntryRemote.prototype.leavegamechannel = function(uid,gameid,cb)
// {
// 	// var sessionService=this.app.get('sessionService');
// 	// var session=sessionService.getByUid(uid)[0];
